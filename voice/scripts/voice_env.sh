...
# Playback: both=3.5mm + 板载喇叭双路同时输出
export PLAYBACK_ROUTE="${PLAYBACK_ROUTE:-both}"
...
export PLAYBACK_GAIN="${PLAYBACK_GAIN:-4.5}"
export PLAYBACK_TARGET_PEAK="${PLAYBACK_TARGET_PEAK:-26000}"
export PLAYBACK_MAX_GAIN="${PLAYBACK_MAX_GAIN:-8.0}"
